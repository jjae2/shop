...
const fileResultInfo = document.querySelector("#fileResultInfo");
let count1=1;
let num1=2; //id용도
...
fileResultInfo.addEventListener("click", function(event){
    if(event.target.classList.contains("fileAddInfo1")){
        ...
        // div.setAttribute("id", "del1"+num1);
        div.className="editor-link-url-input-item";
        div.setAttribute("id", "delInfo"+numInfo);
        ...
        let file1 = document.createElement("input"); //<input>
        file1.setAttribute("type", "file");          //<input type="file">
        file1.setAttribute("name", "filesInfo");         //<input type="file" name="files1">
        divPM.append(file1);

        let button = document.createElement('button'); //<button></button>
        button.className="editor-link-url-input-item__action fileAddInfo1";
        button.setAttribute("type", "button");
        button.setAttribute("title", "추가");
        button.innerHTML = "add";
        button.setAttribute("style", "width: 70px;");
        ...
        let button2 = document.createElement('button');
        button2.className="editor-link-url-input-item__action fileDelInfo1";
        button2.setAttribute("type", "button");
        button2.setAttribute("title", "삭제");
        button2.setAttribute("data-num", "delInfo"+numInfo);
        button2.innerHTML = "remove";
        button2.setAttribute("style", "width: 70px;");
        divPM.append(button2);
        ...
        fileResultInfo.append(div);
  
        numInfo++;
    }

    if(event.target.classList.contains("fileDelInfo1")){
        ...
        if(delNum1 == "delInfo1"){
            ...
            button2.setAttribute("type", "button");
            button2.setAttribute("title", "삭제");
            button2.setAttribute("data-num", "delInfo"+1);
            button2.innerHTML = "remove";
            button2.setAttribute("style", "width: 70px;");
            divPM.append(button2);
            div1.append(divPM);
...
filesInfo.addEventListener("click", function(event){
    if(event.target.classList.contains("fileDeleteBtn")){
