...
<form action="./update" method="post" id="frm" enctype="multipart/form-data">
	...
	<input type="hidden" id="pw" name="pw" value="${member.pw}">
       <section class="css-tbdbun e1y3odo25"><h1 class="css-1pmd5bp e1y3odo24">회원정보수정</h1></section>
   ...
   <!-- <div class="css-1kfo0kb euhjq6q3">
        ...
        <label class="css-ef7ez6 euhjq6q2">이름</label>
            <input class="_3ASDR _1qwAY" field="[object Object]" id="name" name="name" placeholder="" value="${member.name }"></div>
        <span class="email-input__domain">
         ...
         <div class="css-1kfo0kb euhjq6q3">
                ...
                <input class="_3ASDR _1qwAY" field="[object Object]" id="age" name="age" value="${member.age }"></div>
    ...
    <div class="css-1eufcdp e159epbo1">
        <div class="input-group email-input">
            <span class="email-input__local">
                <input class="form-control" placeholder="이메일" id="email" name="email" size="1" value="${member.email }"></span>
            </div>
        </div>
    </div>
        <div class="css-1kfo0kb euhjq6q3">
        <label class="css-ef7ez6 euhjq6q2">주소</label>
        <input class="_3ASDR _1qwAY" field="[object Object]" id="address" name="address" value="${member.address }"></div>
        <div class="css-1kfo0kb euhjq6q3">
        <label class="css-ef7ez6 euhjq6q2">전화번호</label>
            <input class="_3ASDR _1qwAY" field="[object Object]" id="phone" name="phone" value="${member.phone }"></div>
            </c:if>
    ...
    <div class="css-1kfo0kb euhjq6q3">
        <label class="css-ef7ez6 euhjq6q2">전화번호</label>
            <input class="_3ASDR _1qwAY" field="[object Object]" id="phone" name="phone" value="${member.phone }"></div>
    <div class="css-1kfo0kb euhjq6q3">
        <label class="css-ef7ez6 euhjq6q2">회사 이름</label>
        <input class="_3ASDR _1qwAY" field="[object Object]" id="com_name" name="com_name" value=""></div>
    <div class="css-1kfo0kb euhjq6q3">
        <label class="css-ef7ez6 euhjq6q2">회사 주소</label>
        <input class="_3ASDR _1qwAY" field="[object Object]" id="com_address" name="com_address" value=""></div>
     </c:if>
      
        <button class="_3Z6oR _3AsCW _2tsrJ css-1d3w5wq e1y3odo22" type="submit" id="btn">회원 정보 수정</button>
  </form>
