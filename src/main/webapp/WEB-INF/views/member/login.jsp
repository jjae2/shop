...
<body>
	...
	<div class="page">
    <main class="css-jiuql7 ebon26m8">
        <div class="css-fwddxj ebon26m7"></div>
    <div class="css-uu6y3f ebon26m6">
        <a aria-label="오늘의집" class="css-g46w8s ebon26m4" href="/">
            <svg width="147" height="50" viewBox="0 0 147 50" preserveAspectRatio="xMidYMid meet" class="css-1ekfro2 ebon26m3">
                <g fill="none" fill-rule="evenodd"><path fill="#35C5F0" d="M38.42 0H8.35C4.03 0 0 4.02 0 8.33v33.34C0 45.98 4.03 50 8.35 50h33.41c4.33 0 8.35-4.02 8.35-8.33V8.33C50.11 4.02 46.1 0 41.76 0h-3.34z"></path>
                ...
                <form class="css-18ji2p4 e7sx0344" action="./login" method="post">
                    <div class="css-bjn8wh e7sx0343">
                        <input class="_3ASDR _2wjXG css-hg1ckt e7sx0342" name="id" type="text" position="top" placeholder="아이디" value="${cookie.remember.value}">
                        </div>
                    <div class="css-bjn8wh e7sx0343">
                        <input class="_3ASDR _2wjXG css-87d0b4 e7sx0342" name="pw" type="password" position="bottom" placeholder="비밀번호" value="">
                        </div>
                    <button class="_1eWD8 _3Sroy _27do9 css-1rmx362 e7sx0340" type="submit">로그인</button>
                 	<section class="css-hyck8i e5voaya4">
                    <div class="css-lpbwa0 e5voaya3">아이디 저장<input type="checkbox" name="remember" value="1"></div>
                    <a class="css-lpbwa0 e5voaya3" href="./join">회원가입</a>
                    </section>
                    </form>
                    <input type="hidden" name="id" value="">
                    <input type="hidden" name="pw" value="">
                        <a class="css-1gdr9kc ebon26m1" href="#">로그인에 문제가 있으신가요?</a>
                  		<div><a class="css-lpbwa0 e5voaya3" href="./idFind">아이디 찾기</a></div>
                       <div><a class="css-lpbwa0 e5voaya3" href="./pwFind">비밀번호 찾기</a></div>
                    </div>
                    <footer class="css-1kxjigl ebon26m0">© &nbsp;<a href="https://www.bucketplace.co.kr/" target="_blank" rel="noopener noreferrer">bucketplace, Co., Ltd.</a>. All Rights Reserved</footer>
     </main>
</div>
