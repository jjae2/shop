			...
			<div class="layout-navigation-primary__content">
				...
				<div class="layout-navigation-primary__right">
					...
					<div class="layout-navigation-bar-login">
						<a class="layout-navigation-bar-login__item" href="/users/sign_in?redirect_to=%2F">로그인</a>
...
<div class="popout popout--prepared popout--axis-1 popout--dir-2 popout--cross-dir-2" data-popout="true" style="position: absolute; z-index: 1000; top: 70px; right: 179.8px;">
	<div class="animated-popout drop-down__content layout-navigation-bar-user-section__content open open-active">
		<ul class="layout-navigation-bar-user-menu">
			<li class="layout-navigation-bar-user-menu__item-wrap">
				<a class="layout-navigation-bar-user-menu__item" href="/users/16058171">마이페이지</a>
			</li>
			<li class="layout-navigation-bar-user-menu__item-wrap">
			...
			<li class="layout-navigation-bar-user-menu__item-wrap">
				<a class="layout-navigation-bar-user-menu__item" href="https://partners.ohou.se/partner/applications/new">판매자 신청</a>
			</li>
			<li class="layout-navigation-bar-user-menu__item-wrap">
