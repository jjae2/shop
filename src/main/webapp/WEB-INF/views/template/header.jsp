	...
	<div class="navigation_wrap">
					...
					<a class="navigation_top_content_left_logo" aria-label="오늘의집"
						href="/s1"> <svg class="icon" width="74" height="30"
							...
							<g fill="none" fill-rule="evenodd">
								...
								<path fill="#000"
								d="M51.4.49c-.8 0-1.45.65-1.45 1.45v17.78c-1.93.6-5.75 1.13-10.38 1.13h-2.2a1.45 1.45 0 0 0 0 2.9h2.2c2.64 0 7.21-.23 10.38-1.02v4.84a1.45 1.45 0 0 0 2.9 0V1.94c0-.8-.65-1.45-1.45-1.45"></path>
							</g>
						</svg>
					</a>
				</div>
				<nav class="navigation_top_content_menu"
					id="navigation_top_content_menu_color">
					<c:choose>
						<c:when test="${community eq 'community'}">
							<a class="navigation_top_content_menu_style" id="store"
								href="/s1">스토어</a>
							<a
								class="navigation_top_content_menu_style navigation_top_content_menu_style_active"
								id="community" href="/s1/community/">커뮤니티</a>
							<a class="navigation_top_content_menu_style" id="notice"
								href="/s1/notices/list">공지사항</a>
						</c:when>
						<c:otherwise>
							<a
								class="navigation_top_content_menu_style navigation_top_content_menu_style_active"
								id="store" href="/s1">스토어</a>
							<a class="navigation_top_content_menu_style" id="community"
								href="/s1/community/">커뮤니티</a>
							<a class="navigation_top_content_menu_style" id="notice"
								href="/s1/notices/list">공지사항</a>
						</c:otherwise>
					</c:choose>
				...
				<div class="navigation_top_content_right">
					...
					<c:choose>
						<c:when test="${not empty member}">
							<a class="navigation_top_content_right_icon"
								...
								aria-label="스크랩북" href="#"> <svg class="icon" width="24"
									...
									<path fill="none" stroke-width="2"
										d="M3 20.967zm0 0V2.5a.5.5 0 01.5-.5h17a.5.5 0 01.5.5v18.467l-8.057-4.309a2 2 0 00-1.886 0L3 20.968z"></path>
								</svg>
							</a>
							<a class="navigation_top_content_right_icon"
								id="navigation_top_content_right_icon2" title="장바구니"
								aria-label="장바구니" href="#"> <svg class="icon" width="24"
								...
								</svg> <span class="navigation_top_content_right_icon_ticker">5</span>
							</a>
							<div class="drop-down navigation_top_content_right_icon_user">
								<button class="navigation_top_content_right_icon_user-button"
									type="button" aria-label="qomputer" id="user_icon">
									<div
										class="navigation_top_content_right_icon_user-button_image">
										<img class="image"
									...
									<svg
										class="navigation_top_content_right_icon_user-button_caret"
							...
							<div class="navigation_top_content_right_icon_user_menu-wrap"
								data-popout="true"
								style="position: absolute; z-index: 1000; top: 40px; right: 60px;">
								<div class="navigation_top_content_right_icon_user_menu-wrap2"
									id="user_icon_menu">
									<ul class="navigation_top_content_right_icon_user_menu ppp"
										...
										<li
											class="navigation_top_content_right_icon_user_menu_item-wrap">
											<a class="navigation_top_content_right_icon_user_menu_item"
											id="qqt2" href="#">나의 쇼핑</a>
										</li>
										<li
											class="navigation_top_content_right_icon_user_menu_item-wrap">
											<a class="navigation_top_content_right_icon_user_menu_item"
											id="qqt3" href="/s1/notices/list">이벤트</a>
										</li>
										<li
											class="navigation_top_content_right_icon_user_menu_item-wrap">
											<a class="navigation_top_content_right_icon_user_menu_item"
											id="qqt4"
											href="https://partners.ohou.se/partner/applications/new">판매자
												신청</a>
										</li>
										<li
											class="navigation_top_content_right_icon_user_menu_item-wrap">
							...
							<div class="navigation_top_content_right_icon_user_menu-wrap"
								data-popout="true"
								style="position: absolute; z-index: 999; top: 10px; right: 50px;"
								id="user_icon_menu_base">
								<div class="navigation_top_content_right_icon_user_base ppp"
									id="user_icon_menu"></div>
							</div>
							<div class="navigation_top_content_right_login ppp">
								<a class="navigation_top_content_right_login_item no ppp"> </a>
								<a class="navigation_top_content_right_login_item no ppp"
									id="navigation_top_content_right_login_item1"
						...
						<c:otherwise>
							<div class="navigation_top_content_right_login">
								<a class="navigation_top_content_right_login_item no"> </a> <a
									class="navigation_top_content_right_login_item no"
									id="navigation_top_content_right_login_item1"
									href="/s1/member/login">로그인</a> <a
							...
							<div class="drop-down navigation_top_content_right_icon_user ppp">
								<button class="navigation_top_content_right_icon_user-button"
									type="button" aria-label="qomputer" id="user_icon"></button>
							</div>

							<div class="navigation_top_content_right_icon_user_menu-wrap ppp"
								data-popout="true"
								style="position: absolute; z-index: 1000; top: 40px; right: 60px;">
								<div class="navigation_top_content_right_icon_user_menu-wrap2"
									id="user_icon_menu">
		...
		<div class="navigation_bot" style="">
			<div class="navigation_bot_content" style="position: relative;">
				...
				<nav class="navigation_bot_content_menu"
					id="navigation_bot_content_menu">
