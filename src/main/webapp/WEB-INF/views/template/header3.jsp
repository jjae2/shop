...
<header class="header">
	<div class="headerrange" id="headerrange" style="position: absolute; width: 100%; height: 135px;"></div>
				...
				<nav class="navigation_top_content_menu" id="navigation_top_content_menu_color">
					<c:choose>
						<c:when test="${community eq 'community'}">
							<a class="navigation_top_content_menu_style" id="store" href="/s1">스토어</a>
							<a class="navigation_top_content_menu_style navigation_top_content_menu_style_active" id="community" href="/s1/community/">커뮤니티</a>
							<a class="navigation_top_content_menu_style" id="notice" href="/s1/notices/list">공지사항</a>
						</c:when>
						<c:otherwise>
							<a class="navigation_top_content_menu_style navigation_top_content_menu_style_active" id="store" href="/s1">스토어</a>
							<a class="navigation_top_content_menu_style" id="community" href="/s1/community/">커뮤니티</a>
							<a class="navigation_top_content_menu_style" id="notice" href="/s1/notices/list">공지사항</a>
						</c:otherwise>
					</c:choose>	
...
<!--  -->
					...
					<c:choose>
						<c:when test="${not empty member}">
							<a class="navigation_top_content_right_icon" id="navigation_top_content_right_icon1" title="스크랩북" aria-label="스크랩북" href="#">
							...
							<a class="navigation_top_content_right_icon" id="navigation_top_content_right_icon2" title="장바구니" aria-label="장바구니" href="#">
							...
							<div class="navigation_top_content_right_icon_user_menu-wrap" data-popout="true" style="position: absolute; z-index: 1000; top: 40px; right: 60px;">
								<div class="navigation_top_content_right_icon_user_menu-wrap2" id="user_icon_menu">
									<ul class="navigation_top_content_right_icon_user_menu ppp" id="qqt0">
										<li class="navigation_top_content_right_icon_user_menu_item-wrap">
											<a class="navigation_top_content_right_icon_user_menu_item" id="qqt1" href="/s1/member/mypage">마이페이지</a>
										</li>
										<li class="navigation_top_content_right_icon_user_menu_item-wrap">
											<a class="navigation_top_content_right_icon_user_menu_item" id="qqt2" href="#">나의 쇼핑</a>
										</li>
										<li class="navigation_top_content_right_icon_user_menu_item-wrap">
											<a class="navigation_top_content_right_icon_user_menu_item" id="qqt3" href="/s1/notices/list">이벤트</a>
										</li>
										<li class="navigation_top_content_right_icon_user_menu_item-wrap">
											<a class="navigation_top_content_right_icon_user_menu_item" id="qqt4" href="https://partners.ohou.se/partner/applications/new">판매자 신청</a>
										</li>
										<li class="navigation_top_content_right_icon_user_menu_item-wrap">
											<a class="navigation_top_content_right_icon_user_menu_item" id="qqt5" href="/s1/member/logout">로그아웃</a>
										</li>
									</ul>
							    </div>
							</div>
							<div class="navigation_top_content_right_icon_user_menu-wrap" data-popout="true" style="position: absolute; z-index: 999; top: 10px; right: 50px;" id="user_icon_menu_base">
							    <div class="navigation_top_content_right_icon_user_base ppp" id="user_icon_menu"></div>
							</div>
							<div class="navigation_top_content_right_login ppp">
								<a class="navigation_top_content_right_login_item no ppp">　　　　</a>
								<a class="navigation_top_content_right_login_item no ppp" id="navigation_top_content_right_login_item1" href="/s1/member/login">로그인</a>
								<a class="navigation_top_content_right_login_item ppp" id="navigation_top_content_right_login_item2" href="/s1/member/joinCheck">회원가입</a>
							</div>
						</c:when>
						<c:otherwise> 
							<div class="navigation_top_content_right_login">
								<a class="navigation_top_content_right_login_item no">　　　　</a>
								<a class="navigation_top_content_right_login_item no" id="navigation_top_content_right_login_item1" href="/s1/member/login">로그인</a>
								<a class="navigation_top_content_right_login_item" id="navigation_top_content_right_login_item2" href="/s1/member/joinCheck">회원가입</a>
							</div>	
							<a class="navigation_top_content_right_icon ppp" id="navigation_top_content_right_icon1" title="스크랩북" aria-label="스크랩북" href="#">
									
							</a>
							<a class="navigation_top_content_right_icon ppp" id="navigation_top_content_right_icon2" title="장바구니" aria-label="장바구니" href="#"></a>
							<div class="drop-down navigation_top_content_right_icon_user ppp">
								<button class="navigation_top_content_right_icon_user-button" type="button" aria-label="qomputer" id="user_icon"></button>
							</div>
							
							<div class="navigation_top_content_right_icon_user_menu-wrap ppp" data-popout="true" style="position: absolute; z-index: 1000; top: 40px; right: 60px;">
								<div class="navigation_top_content_right_icon_user_menu-wrap2" id="user_icon_menu">
									<ul class="navigation_top_content_right_icon_user_menu ppp" id="qqt0">
										<li class="navigation_top_content_right_icon_user_menu_item-wrap">
											<a class="navigation_top_content_right_icon_user_menu_item" id="qqt1" href="/s1/member/mypage">마이페이지</a>
							...
							<div class="navigation_top_content_right_icon_user_menu-wrap ppp" data-popout="true" style="position: absolute; z-index: 999; top: 10px; right: 50px;" id="user_icon_menu_base">
								<div class="navigation_top_content_right_icon_user_base ppp" id="user_icon_menu"></div>
							</div>			
						</c:otherwise>
					</c:choose>
		...
		<div class="navigation_bot" style="">
			<div class="navigation_bot_content" style="position: relative;">
				...
				<nav class="navigation_bot_content_menu" id="navigation_bot_content_menu">
					...
					<a class="navigation_bot_content_menu_item navigation_bot_content_menu_item_active ppp" id="navigation_bot_content_menu_item6" href="/s1/community">홈</a>
					<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item7" href="#">집들이</a>
					<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item8" href="#">질문과답변</a>
					<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item9" href="/s1/notices/list">공지사항</a> -->


 					<c:choose>
						<c:when test="${community eq 'community'}">
							<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item1" href="/s1">스토어홈</a>
							<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item2" href="#">카테고리</a>		<!-- ?category=0&amp;order=popular -->
							<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item3" href="#">베스트</a>
							<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item4" href="#">오늘의딜</a>				<!-- ?special_feed=true -->
							<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item5" href="/s1/notices/list">세일공지</a>
							<a class="navigation_bot_content_menu_item navigation_bot_content_menu_item_active under" id="navigation_bot_content_menu_item6" href="/s1/community">홈</a>
						...
						<c:otherwise>
							<a class="navigation_bot_content_menu_item navigation_bot_content_menu_item_active under" id="navigation_bot_content_menu_item1" href="/s1">스토어홈</a>
							...
							<a class="navigation_bot_content_menu_item" id="navigation_bot_content_menu_item5" href="/s1/notices/list">세일공지</a>
							<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item6" href="/s1/community">홈</a>
							<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item7" href="#">집들이</a>
							<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item8" href="#">질문과답변</a>
							<a class="navigation_bot_content_menu_item ppp" id="navigation_bot_content_menu_item9" href="/s1/notices/list">공지사항</a>
						</c:otherwise>
