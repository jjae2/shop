										...
										<span class="css-me3hyb e13w87p50">
											<div class="input-group select-input">
												<select name="type" class="form-control">
													<option value="0" id="category0" <c:if test="${dto.type==0}"> selected</c:if>>공지사항</option>
													<option value="1" id="category1" <c:if test="${dto.type==1}"> selected</c:if>>세일공지</option>
												</select>
								...
								<div class="editor-form-group__input">
									<span class="css-me3hyb e13w87p50">
										<div class="css-1nrevy2 eyipm3c1">
											<input placeholder="제목을 입력해주세요" name="title" class="form-control" value="${dto.title}">
						...
						<div class="editor-form-group">
							...
							<div class="editor-form-group__content">
								<div class="editor-form-group__input">
									<span class="css-me3hyb e13w87p50">
										<div class="css-1nrevy2 eyipm3c1">
											<input type="hidden" value="${dto.contents}" id="getContents">
											<textarea placeholder="내용을 입력해주세요" name="contents" class="form-control" value="${dto.contents}" style="width: 500px; height: 700px;"></textarea>
											<span class="css-1quj80b eyipm3c0"></span>
										</div>
									</span>
								</div>
								...
								<div class="editor-form-group__input">
									<div class="editor-link-url-input">
										<div id="fileResult1">
											...
											<div id="files">
												<c:forEach items="${dto.noticeFileDTOs}" var="f" varStatus="vs">								
